    ...
    //    	}
       	for (var j = 0; j <lstJourneys.length; j++) {
			...
			$('#ActiveOrders').append("<tbody><tr><td onclick='ShowJourney("+j+")'>"+lstJourneys[j].JourneyId+"</td><td onclick='ShowJourney("+j+")'>"+
									lstJourneys[j].JourneyDate+"</td><td onclick='ShowJourney("+j+")'>"+lstJourneys[j].truckId+"</td><td onclick='ShowJourney("+j+")'>"+driver.person.PERSONNAME+" "+driver.person.PERSONLASTNAME+"</td><td onclick='ShowJourney("+j+")'>"+RCName+
